...
export function Recipe({ recipe }) {
	...
	return (
		<article
			className="grid w-11/12 grid-rows-1 mx-auto my-4 overflow-hidden transition-colors duration-200 ease-in-out bg-center bg-no-repeat bg-cover rounded-lg shadow-lg place-items-end lg:grid-cols-1 md:w-3/4 lg:w-11/12 h-96"
			style={{
